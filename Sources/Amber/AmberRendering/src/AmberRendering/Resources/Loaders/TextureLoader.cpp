...
std::string AmberRendering::Resources::Loaders::TextureLoader::FILE_TRACE;

AmberRendering::Resources::Texture* AmberRendering::Resources::Loaders::TextureLoader::Create(std::string p_filePath, ETextureFilteringMode p_firstFilter, ETextureFilteringMode p_secondFilter, ETextureType p_textureType, bool p_flipVertically, bool p_generateMipmap)
{
	...
	if (unsigned char* dataBuffer = stbi_load(p_filePath.c_str(), &textureWidth, &textureHeight, &bitsPerPixel, 4); dataBuffer)
	{
		...
		std::string name = AmberTools::Utils::String::ExtractFileNameFromPath(p_filePath);
...
AmberRendering::Resources::Texture* AmberRendering::Resources::Loaders::TextureLoader::CreateColor(uint32_t p_data, ETextureFilteringMode p_firstFilter, ETextureFilteringMode p_secondFilter, bool p_generateMipmap)
{
	GLuint textureID;
	glGenTextures(1, &textureID);
	glBindTexture(GL_TEXTURE_2D, textureID);
...
AmberRendering::Resources::Texture* AmberRendering::Resources::Loaders::TextureLoader::CreateFromMemory(uint8_t* p_data, uint32_t p_width, uint32_t p_height, ETextureFilteringMode p_firstFilter, ETextureFilteringMode p_secondFilter, bool p_generateMipmap)
{
	GLuint textureID;
	glGenTextures(1, &textureID);
	glBindTexture(GL_TEXTURE_2D, textureID);
...
void AmberRendering::Resources::Loaders::TextureLoader::Reload(Texture& p_texture, const std::string& p_filePath, ETextureFilteringMode p_firstFilter, ETextureFilteringMode p_secondFilter, ETextureType p_textureType, bool p_flipVertically, bool p_generateMipmap)
{
...
bool AmberRendering::Resources::Loaders::TextureLoader::Destroy(Texture*& p_textureInstance)
{
...
bool AmberRendering::Resources::Loaders::TextureLoader::Delete(Texture* p_textureInstance)
{
	if (p_textureInstance)
	{
		glDeleteTextures(1, &p_textureInstance->ID);
