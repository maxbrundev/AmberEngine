...
AmberRendering::Resources::Shader::Shader(std::string p_filePath, uint32_t p_id) : ID(p_id), Path(std::move(p_filePath))
{
	QueryUniforms();
}

AmberRendering::Resources::Shader::~Shader()
{
	glDeleteProgram(ID);
}

void AmberRendering::Resources::Shader::QueryUniforms()
{
	Uniforms.clear();
...
void AmberRendering::Resources::Shader::Bind() const
{
	glUseProgram(ID);
}

void AmberRendering::Resources::Shader::Unbind() const
{
	glUseProgram(0);
}

void AmberRendering::Resources::Shader::SetUniformIntPointer(const std::string_view p_name, int p_count, const int* p_value)
{
	glUniform1iv(GetUniformLocation(p_name), p_count, p_value);
}

void AmberRendering::Resources::Shader::SetUniformInt(const std::string_view p_name, const int p_value)
{
	glUniform1i(GetUniformLocation(p_name), p_value);
}

void AmberRendering::Resources::Shader::SetUniformFloat(const std::string_view p_name, const float p_value)
{
	glUniform1f(GetUniformLocation(p_name), p_value);
}

void AmberRendering::Resources::Shader::SetUniform4Float(const std::string_view p_name, const float p_v0, const float p_v1, const float p_v2, const float p_v3)
{
	glUniform4f(GetUniformLocation(p_name), p_v0, p_v1, p_v2, p_v3);
}

void AmberRendering::Resources::Shader::SetUniformVec2(const std::string_view p_name, const glm::vec2& p_vec2)
{
	glUniform2f(GetUniformLocation(p_name), p_vec2.x, p_vec2.y);
}

void AmberRendering::Resources::Shader::SetUniformVec3(const std::string_view p_name, const glm::vec3& p_vec3)
{
	glUniform3f(GetUniformLocation(p_name), p_vec3.x, p_vec3.y, p_vec3.z);
}

void AmberRendering::Resources::Shader::SetUniformVec4(const std::string_view p_name, const glm::vec4& p_vec4)
{
	glUniform4f(GetUniformLocation(p_name), p_vec4.x, p_vec4.y, p_vec4.z, p_vec4.w);
}

void AmberRendering::Resources::Shader::SetUniformMat4(const std::string_view p_name, const glm::mat4& p_mat4)
{
	glUniformMatrix4fv(GetUniformLocation(p_name), 1, GL_FALSE, &p_mat4[0][0]);
}

int AmberRendering::Resources::Shader::GetUniformInt(const std::string& p_name)
{
	int value;
...
float AmberRendering::Resources::Shader::GetUniformFloat(const std::string& p_name)
{
	float value;
...
glm::vec2 AmberRendering::Resources::Shader::GetUniformVec2(const std::string& p_name)
{
	GLfloat values[2];
...
glm::vec3 AmberRendering::Resources::Shader::GetUniformVec3(const std::string& p_name)
{
	GLfloat values[3];
	glGetUniformfv(ID, GetUniformLocation(p_name), values);
...
glm::vec4 AmberRendering::Resources::Shader::GetUniformVec4(const std::string& p_name)
{
	GLfloat values[4];
	glGetUniformfv(ID, GetUniformLocation(p_name), values);
...
glm::mat4 AmberRendering::Resources::Shader::GetUniformMat4(const std::string& p_name)
{
	GLfloat values[16];
	glGetUniformfv(ID, GetUniformLocation(p_name), values);
...
const AmberRendering::Resources::UniformInfo* AmberRendering::Resources::Shader::GetUniformInfo(const std::string& p_name) const
{
...
bool AmberRendering::Resources::Shader::IsEngineUBOUniform(const std::string& p_uniformName)
{
	return p_uniformName.rfind("ubo_", 0) == 0;
}

uint32_t AmberRendering::Resources::Shader::GetUniformLocation(const std::string_view p_name)
{
