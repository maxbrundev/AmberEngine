...
std::pair<std::string, std::string> AmberRendering::Resources::RawShader::GetGrid()
{
...
std::pair<std::string, std::string> AmberRendering::Resources::RawShader::GetGizmo()
{
	std::pair<std::string, std::string> source;
...
std::pair<std::string, std::string> AmberRendering::Resources::RawShader::GetNormalVisualizer()
{
	std::pair<std::string, std::string> source;
...
std::pair<std::string, std::string> AmberRendering::Resources::RawShader::GetBillboard()
{
	std::pair<std::string, std::string> source;
