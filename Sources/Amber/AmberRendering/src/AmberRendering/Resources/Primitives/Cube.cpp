...
#include "AmberRendering/Resources/Primitives/Cube.h"

std::vector<AmberRendering::Resources::Primitives::Vertex> AmberRendering::Resources::Primitives::Cube::m_vertices;
glm::vec3 AmberRendering::Resources::Primitives::Cube::m_positions[8];
glm::vec3 AmberRendering::Resources::Primitives::Cube::m_normals[6];
glm::vec2 AmberRendering::Resources::Primitives::Cube::m_textureCoordinates[4];
bool AmberRendering::Resources::Primitives::Cube::m_initialized = false;

void AmberRendering::Resources::Primitives::Cube::Setup()
{
	if (!m_initialized)
	{
		m_initialized = true;
...
void AmberRendering::Resources::Primitives::Cube::InitCubePositions()
{
...
void AmberRendering::Resources::Primitives::Cube::InitCubeTextureCoordinates()
{
...
void AmberRendering::Resources::Primitives::Cube::InitCubeNormals()
{
...
void AmberRendering::Resources::Primitives::Cube::InitCubeVertices()
{
...
void AmberRendering::Resources::Primitives::Cube::CreateTriangle(uint8_t pos1, uint8_t pos2, uint8_t pos3, uint8_t text1,
...
std::vector<AmberRendering::Resources::Primitives::Vertex>& AmberRendering::Resources::Primitives::Cube::GetVertices()
{
	return m_vertices;
}
