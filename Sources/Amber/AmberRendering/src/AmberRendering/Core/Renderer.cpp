...
void AmberRendering::Core::Renderer::SetClearColor(float p_red, float p_green, float p_blue, float p_alpha) const
{
	glClearColor(p_red, p_green, p_blue, p_alpha);
}

void AmberRendering::Core::Renderer::Clear(bool p_colorBuffer, bool p_depthBuffer, bool p_stencilBuffer) const
{
	//TODO: Clean
...
void AmberRendering::Core::Renderer::Clear(AmberRendering::Entities::Camera& p_camera, bool p_colorBuffer, bool p_depthBuffer, bool p_stencilBuffer) const
{
...
uint8_t AmberRendering::Core::Renderer::FetchGLState() const
{
	uint8_t result = 0;
...
void AmberRendering::Core::Renderer::ApplyStateMask(uint8_t p_mask)
{
	if (p_mask != m_state)
	{
		using namespace AmberRendering::Settings;
...
const AmberRendering::Core::Renderer::FrameInfo& AmberRendering::Core::Renderer::GetFrameInfo() const
{
	return m_frameInfo;
}

void AmberRendering::Core::Renderer::Draw(AmberRendering::Resources::IMesh& p_mesh, Settings::EPrimitiveMode p_primitiveMode, uint32_t p_instances)
{
	if (p_instances > 0)
	{
...
AmberRendering::Context::Driver& AmberRendering::Core::Renderer::GetDriver() const
{
	return m_driver;
}
