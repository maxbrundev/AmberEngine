...
postbuildcommands
{
	"xcopy /Y /I /C \"%{wks.location}..\\..\\Build\\AmberGame\\%{cfg.platform}\\Debug\" \"%{wks.location}..\\..\\Build\\AmberEditor\\%{cfg.platform}\\Debug\\Builder\\Development\"",
	"xcopy /Y /I /C \"%{wks.location}..\\..\\Build\\AmberGame\\%{cfg.platform}\\Debug\" \"%{wks.location}..\\..\\Build\\AmberEditor\\%{cfg.platform}\\Release\\Builder\\Development\"",
	"EXIT /B 0"
}
...
postbuildcommands
{
	"xcopy /Y /I /C \"%{wks.location}..\\..\\Build\\AmberGame\\%{cfg.platform}\\Release\" \"%{wks.location}..\\..\\Build\\AmberEditor\\%{cfg.platform}\\Debug\\Builder\\Shipping\"",
	"xcopy /Y /I /C \"%{wks.location}..\\..\\Build\\AmberGame\\%{cfg.platform}\\Release\" \"%{wks.location}..\\..\\Build\\AmberEditor\\%{cfg.platform}\\Release\\Builder\\Shipping\"",
	"EXIT /B 0"
}
