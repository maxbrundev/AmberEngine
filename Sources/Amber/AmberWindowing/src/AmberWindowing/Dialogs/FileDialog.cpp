...
AmberWindowing::Dialogs::FileDialog::FileDialog(std::function<int(tagOFNA*)> p_callback, const std::string& p_dialogTitle) :
...
void AmberWindowing::Dialogs::FileDialog::SetInitialDirectory(const std::string & p_initialDirectory)
{
	m_initialDirectory = p_initialDirectory;
}

void AmberWindowing::Dialogs::FileDialog::Show(EExplorerFlags p_flags)
{
	OPENFILENAME ofn;
...
bool AmberWindowing::Dialogs::FileDialog::HasSucceeded() const
{
	return m_succeeded;
}

std::string AmberWindowing::Dialogs::FileDialog::GetSelectedFileName()
{
	return m_filename;
}

std::string AmberWindowing::Dialogs::FileDialog::GetSelectedFilePath()
{
	return m_filepath;
}

std::string AmberWindowing::Dialogs::FileDialog::GetErrorInfo()
{
	return m_error;
}

bool AmberWindowing::Dialogs::FileDialog::IsFileExisting() const
{
	return std::filesystem::exists(m_filepath);
}

void AmberWindowing::Dialogs::FileDialog::HandleError()
{
