...
#include "AmberWindowing/Inputs/EKey.h"
#include "AmberWindowing/Inputs/EKeyState.h"
#include "AmberWindowing/Inputs/EMouseButton.h"
#include "AmberWindowing/Inputs/EMouseButtonState.h"

#include "AmberWindowing/Context/Window.h"

namespace AmberWindowing::Inputs
{
	class InputManager
	{
	public:
		InputManager(AmberWindowing::Context::Window& p_window);
		~InputManager();
