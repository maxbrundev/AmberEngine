...
namespace AmberEngine::Resources
{
	...
	public:
		Texture(const std::string p_filePath, const std::string p_name, uint32_t p_id, uint32_t p_width, uint32_t p_height, uint32_t p_bitsPerPixel, ETextureFilteringMode p_firstFilter, ETextureFilteringMode p_secondFilter, ETextureType p_textureType, bool p_generateMipmap);
		~Texture() = default;
