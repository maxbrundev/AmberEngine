...
std::string AmberTools::Utils::String::ExtractDirectoryFromPath(const std::string& p_path)
{
...
std::string AmberTools::Utils::String::ExtractFileNameFromPath(const std::string& p_path)
{
...
std::string AmberTools::Utils::String::RemoveExtensionFromFileName(const std::string& p_file)
{
...
bool AmberTools::Utils::String::Replace(std::string& p_target, const std::string& p_from, const std::string& p_to)
{
...
void AmberTools::Utils::String::ReplaceAll(std::string& p_target, const std::string& p_from, const std::string& p_to)
{
...
std::string AmberTools::Utils::String::GenerateUnique(const std::string& p_source,
