...
float AmberTools::Analytics::Hardware::CPUInfo::CalculateCPULoad()
{
...
float AmberTools::Analytics::Hardware::CPUInfo::CalculateCPULoad(uint64_t p_idleTicks, uint64_t p_totalTicks)
{
