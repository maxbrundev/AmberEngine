...
AmberTools::Analytics::Hardware::HardwareInfo::HardwareInfo(double p_timeInterval) :
...
AmberTools::Analytics::Hardware::HardwareReport AmberTools::Analytics::Hardware::HardwareInfo::GenerateReport()
{
...
void AmberTools::Analytics::Hardware::HardwareInfo::Tick()
{
...
void AmberTools::Analytics::Hardware::HardwareInfo::Update()
{
