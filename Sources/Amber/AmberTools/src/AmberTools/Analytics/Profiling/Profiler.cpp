...
bool											AmberTools::Analytics::Profiling::Profiler::__ENABLED;
std::mutex										AmberTools::Analytics::Profiling::Profiler::__SAVE_MUTEX;
std::unordered_map<std::string, double>			AmberTools::Analytics::Profiling::Profiler::__ELPASED_HISTORY;
std::unordered_map<std::string, uint64_t>		AmberTools::Analytics::Profiling::Profiler::__CALLS_COUNTER;
std::vector<std::thread::id>					AmberTools::Analytics::Profiling::Profiler::__WORKING_THREADS;
uint32_t										AmberTools::Analytics::Profiling::Profiler::__ELAPSED_FRAMES;

AmberTools::Analytics::Profiling::Profiler::Profiler()
{
	m_lastTime = std::chrono::high_resolution_clock::now();
	__ENABLED = false;
}

AmberTools::Analytics::Profiling::ProfilerReport AmberTools::Analytics::Profiling::Profiler::GenerateReport()
{
...
void AmberTools::Analytics::Profiling::Profiler::ClearHistory()
{
...
void AmberTools::Analytics::Profiling::Profiler::Update(float p_deltaTime)
{
	if (IsEnabled())
	{
		++__ELAPSED_FRAMES;
...
void AmberTools::Analytics::Profiling::Profiler::Save(AmberTools::Analytics::Profiling::ProfilerSpy& p_spy)
{
	__SAVE_MUTEX.lock();
...
bool AmberTools::Analytics::Profiling::Profiler::IsEnabled()
{
	return __ENABLED;
}

void AmberTools::Analytics::Profiling::Profiler::ToggleEnable()
{
	__ENABLED = !__ENABLED;
}

void AmberTools::Analytics::Profiling::Profiler::Enable()
{
	__ENABLED = true;
}

void AmberTools::Analytics::Profiling::Profiler::Disable()
{
	__ENABLED = false;
}