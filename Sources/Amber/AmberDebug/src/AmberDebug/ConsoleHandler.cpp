...
#include "AmberDebug/ConsoleColor.h"
#include "AmberDebug/HandlerHeader.h"

void AmberDebug::ConsoleHandler::Log(const LogData& p_logData)
{
...
std::string AmberDebug::ConsoleHandler::GetLogHeader(ELogLevel p_logLevel)
{
	switch (p_logLevel)
	{
