...
#include "AmberPhysics/Settings/BodySettings.h"

namespace AmberPhysics::Core { class PhysicsEngine; }
...
namespace AmberPhysics::Entities
{
	...
	{
	public:
		friend class AmberPhysics::Core::PhysicsEngine;
		...
		PhysicalObject();
		PhysicalObject(AmberMaths::Transform& p_transform);
	...
	public:
		AmberTools::Eventing::Event<PhysicalObject&>			CollisionStartEvent;
		AmberTools::Eventing::Event<PhysicalObject&>			CollisionStayEvent;
		AmberTools::Eventing::Event<PhysicalObject&>			CollisionStopEvent;
		
		AmberTools::Eventing::Event<PhysicalObject&>			TriggerStartEvent;
		AmberTools::Eventing::Event<PhysicalObject&>			TriggerStayEvent;
		AmberTools::Eventing::Event<PhysicalObject&>			TriggerStopEvent;
	...
	private:
		...
		static AmberTools::Eventing::Event<PhysicalObject&>	CreatedEvent;
		static AmberTools::Eventing::Event<PhysicalObject&>	DestroyedEvent;
		static AmberTools::Eventing::Event<btRigidBody&>		ConsiderEvent;
		static AmberTools::Eventing::Event<btRigidBody&>		UnconsiderEvent;
