...
AmberCore::ECS::Components::CAmbientBoxLight::CAmbientBoxLight(Actor& p_owner) : CLight(p_owner, AmberRendering::Settings::ELightType::AMBIENT_BOX)
{
	m_data.Type = static_cast<float>(AmberRendering::Settings::ELightType::AMBIENT_BOX);
...
std::string AmberCore::ECS::Components::CAmbientBoxLight::GetName()
{
	return "Ambient Box Light";
}

glm::vec3 AmberCore::ECS::Components::CAmbientBoxLight::GetSize() const
{
	return { m_data.Constant, m_data.Linear, m_data.Quadratic };
}

void AmberCore::ECS::Components::CAmbientBoxLight::SetSize(const glm::vec3& p_size)
{
...
void AmberCore::ECS::Components::CAmbientBoxLight::OnSerialize(tinyxml2::XMLDocument& p_doc,
...
void AmberCore::ECS::Components::CAmbientBoxLight::OnDeserialize(tinyxml2::XMLDocument& p_doc,
	tinyxml2::XMLNode* p_node)
{
...
void AmberCore::ECS::Components::CAmbientBoxLight::OnInspector(AmberUI::WidgetContainer& p_root)
{
	...
	AmberCore::Helpers::GUIDrawer::DrawVec3(p_root, "Size", sizeGatherer, sizeProvider, 0.1f, 0.0f);
}
