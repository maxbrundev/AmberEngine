...
AmberTools::Eventing::Event<bool> AmberCore::SceneSystem::Scene::DirtyEvent;


AmberCore::SceneSystem::Scene::~Scene()
{
...
void AmberCore::SceneSystem::Scene::Play()
{
	m_isPlaying = true;
...
bool AmberCore::SceneSystem::Scene::IsPlaying() const
{
	return m_isPlaying;
}

void AmberCore::SceneSystem::Scene::Update(float p_deltaTime)
{
...
AmberCore::ECS::Actor& AmberCore::SceneSystem::Scene::CreateActor()
{
	return CreateActor("New Actor");
}

AmberCore::ECS::Actor& AmberCore::SceneSystem::Scene::CreateActor(const std::string& p_name, const std::string& p_tag)
{
...
std::vector<AmberCore::ECS::Actor*>& AmberCore::SceneSystem::Scene::GetActors()
{
	return m_actors;
}

const AmberCore::SceneSystem::Scene::FastAccessComponents& AmberCore::SceneSystem::Scene::GetFastAccessComponents() const
{
	return m_fastAccessComponents;
}

void AmberCore::SceneSystem::Scene::OnSerialize(tinyxml2::XMLDocument& p_doc, tinyxml2::XMLNode* p_node)
{
...
void AmberCore::SceneSystem::Scene::OnDeserialize(tinyxml2::XMLDocument& p_doc, tinyxml2::XMLNode* p_node)
{
...
bool AmberCore::SceneSystem::Scene::DestroyActor(ECS::Actor& p_target)
{
...
AmberCore::ECS::Actor* AmberCore::SceneSystem::Scene::FindActorByID(int64_t p_id)
{
...
AmberCore::ECS::Actor* AmberCore::SceneSystem::Scene::FindActorByName(const std::string& p_name)
{
	auto result = std::find_if(m_actors.begin(), m_actors.end(), [p_name](ECS::Actor* element)
	{
...
AmberCore::ECS::Actor* AmberCore::SceneSystem::Scene::FindActorByTag(const std::string& p_tag)
{
	auto result = std::find_if(m_actors.begin(), m_actors.end(), [p_tag](ECS::Actor* element)
	{
...
std::vector<std::reference_wrapper<AmberCore::ECS::Actor>> AmberCore::SceneSystem::Scene::FindActorsByName(const std::string& p_name)
{
...
std::vector<std::reference_wrapper<AmberCore::ECS::Actor>> AmberCore::SceneSystem::Scene::FindActorsByTag(const std::string& p_tag)
{
	std::vector<std::reference_wrapper<ECS::Actor>> actors;
...
void AmberCore::SceneSystem::Scene::CollectGarbage()
{
...
void AmberCore::SceneSystem::Scene::SetDirty(bool p_isDirty)
{
	m_isDirty = p_isDirty;
}

void AmberCore::SceneSystem::Scene::OnComponentAdded(ECS::Components::AComponent& p_compononent)
{
...
void AmberCore::SceneSystem::Scene::OnComponentRemoved(ECS::Components::AComponent& p_compononent)
{
	if (auto result = dynamic_cast<ECS::Components::CModelRenderer*>(&p_compononent))
