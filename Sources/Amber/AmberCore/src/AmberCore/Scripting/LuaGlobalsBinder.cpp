	...
	p_luaState.new_enum<AmberWindowing::Inputs::EKey>("Key",
		{
			...
			{"ALPHA_0", AmberWindowing::Inputs::EKey::KEY_0},
			{"ALPHA_1", AmberWindowing::Inputs::EKey::KEY_1},
			{"ALPHA_2", AmberWindowing::Inputs::EKey::KEY_2},
			{"ALPHA_3", AmberWindowing::Inputs::EKey::KEY_3},
			{"ALPHA_4", AmberWindowing::Inputs::EKey::KEY_4},
			{"ALPHA_5", AmberWindowing::Inputs::EKey::KEY_5},
			{"ALPHA_6", AmberWindowing::Inputs::EKey::KEY_6},
			{"ALPHA_7", AmberWindowing::Inputs::EKey::KEY_7},
			{"ALPHA_8", AmberWindowing::Inputs::EKey::KEY_8},
			{"ALPHA_9", AmberWindowing::Inputs::EKey::KEY_9},
