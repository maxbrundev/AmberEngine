...
AmberCore::Resources::Material* AmberCore::Resources::Loaders::MaterialLoader::Create(const std::string& p_path)
{
...
void AmberCore::Resources::Loaders::MaterialLoader::Reload(Material& p_material, const std::string& p_path)
{
	tinyxml2::XMLDocument doc;
	doc.LoadFile(p_path.c_str());
	if (!doc.Error())
...
void AmberCore::Resources::Loaders::MaterialLoader::Save(Material& p_material, const std::string& p_path)
{
	tinyxml2::XMLDocument doc;
...
bool AmberCore::Resources::Loaders::MaterialLoader::Destroy(Material*& p_material)
{
	if (p_material)
	{
		delete p_material;
