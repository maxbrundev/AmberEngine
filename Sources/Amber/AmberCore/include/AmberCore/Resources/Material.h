...
{
	class Material : public AmberCore::API::ISerializable
	{
	public:
		Material();
		~Material();

		void Bind(const AmberRendering::Resources::Texture* p_emptyTexture) const;
		void Unbind() const;
		...
		void SetShader(AmberRendering::Resources::Shader* p_shader);
		...
		AmberRendering::Resources::Shader* GetShader() const;
