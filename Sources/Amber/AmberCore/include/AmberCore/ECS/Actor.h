...
namespace AmberCore::ECS
{
	...
	{
	public:
		static AmberTools::Eventing::Event<Actor&>         CreatedEvent;
		static AmberTools::Eventing::Event<Actor&>         DestroyEvent;
		static AmberTools::Eventing::Event<Actor&, Actor&> AttachEvent;
		static AmberTools::Eventing::Event<Actor&, Actor*> DettachEvent;

		AmberTools::Eventing::Event<Components::AComponent&> ComponentAddedEvent;
		AmberTools::Eventing::Event<Components::AComponent&> ComponentRemovedEvent;

		AmberTools::Eventing::Event<Components::Behaviour&> BehaviourAddedEvent;
		AmberTools::Eventing::Event<Components::Behaviour&> BehaviourRemovedEvent;
