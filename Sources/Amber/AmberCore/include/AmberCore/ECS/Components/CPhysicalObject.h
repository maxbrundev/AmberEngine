...
namespace AmberCore::ECS::Components
{
	...
	public:
		...
		AmberPhysics::Entities::PhysicalObject::ECollisionDetectionMode GetCollisionDetectionMode() const;
		...
		AmberPhysics::Entities::PhysicalObject::EActivationState GetActivationState() const;

		void SetMass(float p_mass);

		void SetCollisionDetectionMode(AmberPhysics::Entities::PhysicalObject::ECollisionDetectionMode p_mode);
		...
		void SetActivationState(AmberPhysics::Entities::PhysicalObject::EActivationState p_activationState);
	...
	public:
		AmberTools::Eventing::Event<CPhysicalObject&> CollisionEnterEvent;
		AmberTools::Eventing::Event<CPhysicalObject&> CollisionStayEvent;
		AmberTools::Eventing::Event<CPhysicalObject&> CollisionExitEvent;

		AmberTools::Eventing::Event<CPhysicalObject&> TriggerEnterEvent;
		AmberTools::Eventing::Event<CPhysicalObject&> TriggerStayEvent;
		AmberTools::Eventing::Event<CPhysicalObject&> TriggerExitEvent;

	protected:
		std::unique_ptr<AmberPhysics::Entities::PhysicalObject> m_physicalObject;
	};
}