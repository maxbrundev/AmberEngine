#include "AmberEngine/Resources/Mesh/Cube.h"

std::vector<AmberEngine::PrimitiveMesh::Vertex> AmberEngine::PrimitiveMesh::Cube::m_vertices;
glm::vec3 AmberEngine::PrimitiveMesh::Cube::m_positions[8];
glm::vec3 AmberEngine::PrimitiveMesh::Cube::m_normals[6];
glm::vec2 AmberEngine::PrimitiveMesh::Cube::m_textureCoordinates[4];
bool AmberEngine::PrimitiveMesh::Cube::m_initialized = false;

void AmberEngine::PrimitiveMesh::Cube::Setup()
{
	if (!m_initialized)
	{
		m_initialized = true;
...
void AmberEngine::PrimitiveMesh::Cube::InitCubePositions()
{
...
void AmberEngine::PrimitiveMesh::Cube::InitCubeTextureCoordinates()
{
...
void AmberEngine::PrimitiveMesh::Cube::InitCubeNormals()
{
...
void AmberEngine::PrimitiveMesh::Cube::InitCubeVertices()
{
...
void AmberEngine::PrimitiveMesh::Cube::CreateTriangle(uint8_t pos1, uint8_t pos2, uint8_t pos3, uint8_t text1,
...
std::vector<AmberEngine::PrimitiveMesh::Vertex>& AmberEngine::PrimitiveMesh::Cube::GetVertices()
{
	return m_vertices;
}