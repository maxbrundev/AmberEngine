...
void AmberEngine::Resources::Shader::SetUniformIntPointer(const std::string& p_name, int p_count, const int* p_value)
{
	GLCall(glUniform1iv(GetUniformLocation(p_name), p_count, p_value));
}

void AmberEngine::Resources::Shader::SetUniform1i(const std::string& p_name, const int p_value)
{
	GLCall(glUniform1i(GetUniformLocation(p_name), p_value));
}

void AmberEngine::Resources::Shader::SetUniform1f(const std::string& p_name, const float p_value)
{
	GLCall(glUniform1f(GetUniformLocation(p_name), p_value));
}

void AmberEngine::Resources::Shader::SetUniform4f(const std::string& p_name, const float p_v0, const float p_v1, const float p_v2, const float p_v3)
{
	GLCall(glUniform4f(GetUniformLocation(p_name), p_v0, p_v1, p_v2, p_v3));
}

void AmberEngine::Resources::Shader::SetUniformVec3(const std::string& p_name, const glm::vec3& p_vec3)
{
	GLCall(glUniform3f(GetUniformLocation(p_name), p_vec3.x, p_vec3.y, p_vec3.z));
}

void AmberEngine::Resources::Shader::SetUniformVec4(const std::string& p_name, const glm::vec4& p_vec4)
{
	GLCall(glUniform4f(GetUniformLocation(p_name), p_vec4.x, p_vec4.y, p_vec4.z, p_vec4.w));
}

void AmberEngine::Resources::Shader::SetUniformMat4(const std::string& p_name, const glm::mat4& p_mat4)
{
...
unsigned int AmberEngine::Resources::Shader::GetUniformLocation(const std::string& name)
{
