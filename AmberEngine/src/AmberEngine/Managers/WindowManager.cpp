...
AmberEngine::Managers::WindowManager::WindowManager(const Settings::DeviceSettings& p_deviceSettings, const Settings::DriverSettings& p_driverSettings) : m_device(p_deviceSettings), m_driver(p_driverSettings)
{
}
