...
namespace AmberEngine::Managers
{
	...
	public:
		...
		static GLdouble m_mouseLastX;
		static GLdouble m_mouseLastY;
		static GLdouble m_mouseXOffset;
		static GLdouble m_mouseYOffset;
		...
		static bool GetKey(Key p_key);
		static bool GetKeyDown(Key p_key);
		static bool GetKeyUp(Key p_key);

		static GLdouble MouseX();
		static GLdouble MouseY();
		static GLdouble MouseXOffset();
		static GLdouble MouseYOffset();
