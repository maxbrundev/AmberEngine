...
RenderEngine::Resources::Texture::Texture(const std::string& p_filePath) : m_textureId(0), m_path(p_filePath), m_width(0), m_height(0), m_bitsPerPixel(0)
{
...
void RenderEngine::Resources::Texture::Bind(const unsigned int& p_slot) const
{
